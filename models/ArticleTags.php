...
/**
 * This is the model class for table "db_article_tags".
 *
 * The followings are the available columns in table 'db_article_tags':
 * @property integer $id_article
 * @property integer $id_tag
 *
 * The followings are the available model relations:
 * @property DbTags $idTag
 * @property DbArticle $idArticle
 */
class DbArticleTags extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			...
			'idArticle' => array(self::BELONGS_TO, 'DbArticle', 'id_article'),
		);
	}
	 ...
	 * @return DbArticleTags the static model class
	 */
